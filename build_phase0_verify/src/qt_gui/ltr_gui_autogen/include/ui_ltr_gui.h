...
public:
    ...
    void setupUi(QWidget *Ltr_gui)
    {
        ...
        previewModeLabel = new QLabel(tab);
        previewModeLabel->setObjectName("previewModeLabel");

        horizontalLayout_2->addWidget(previewModeLabel);

        previewMode = new QComboBox(tab);
        previewMode->addItem(QString());
        previewMode->addItem(QString());
        previewMode->setObjectName("previewMode");

        horizontalLayout_2->addWidget(previewMode);
        ...
        cameraStatus = new QLabel(Ltr_gui);
        cameraStatus->setObjectName("cameraStatus");
        cameraStatus->setFrameShape(QFrame::StyledPanel);
        cameraStatus->setFrameShadow(QFrame::Plain);
        cameraStatus->setWordWrap(true);

        verticalLayout->addWidget(cameraStatus);
    ...
    void retranslateUi(QWidget *Ltr_gui)
    {
        ...
        previewModeLabel->setText(QCoreApplication::translate("Ltr_gui", "Preview Mode", nullptr));
        previewMode->setItemText(0, QCoreApplication::translate("Ltr_gui", "Preview grayscale", nullptr));
        previewMode->setItemText(1, QCoreApplication::translate("Ltr_gui", "Processed mask", nullptr));
