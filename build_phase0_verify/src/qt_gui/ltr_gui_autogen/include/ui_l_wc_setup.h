...
public:
    ...
    void setupUi(QWidget *WebcamSetupForm)
    {
        ...
        WebcamModeHint = new QLabel(frame);
        WebcamModeHint->setObjectName("WebcamModeHint");
        WebcamModeHint->setWordWrap(true);

        gridLayout_2->addWidget(WebcamModeHint, 2, 0, 1, 2);
    ...
    void retranslateUi(QWidget *WebcamSetupForm)
    {
        ...
        WebcamModeHint->setText(QString());
