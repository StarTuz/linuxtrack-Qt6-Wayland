...
public:
    ...
    void setupUi(QWidget *WebcamFtSetupForm)
    {
        ...
        WebcamFtModeHint = new QLabel(frame);
        WebcamFtModeHint->setObjectName("WebcamFtModeHint");
        WebcamFtModeHint->setWordWrap(true);

        gridLayout_2->addWidget(WebcamFtModeHint, 2, 0, 1, 2);
        ...
        CameraFov = new QDoubleSpinBox(frame_2);
        CameraFov->setObjectName("CameraFov");
        CameraFov->setDecimals(1);
        CameraFov->setMinimum(30.000000000000000);
        CameraFov->setMaximum(140.000000000000000);
        CameraFov->setValue(56.000000000000000);

        gridLayout->addWidget(CameraFov, 2, 2, 1, 1);
    ...
    void retranslateUi(QWidget *WebcamFtSetupForm)
    {
        ...
        WebcamFtModeHint->setText(QString());
        ...
        label_8->setText(QCoreApplication::translate("WebcamFtSetupForm", "Camera FOV:", nullptr));
        label_12->setText(QCoreApplication::translate("WebcamFtSetupForm", "deg", nullptr));
    } // retranslateUi
