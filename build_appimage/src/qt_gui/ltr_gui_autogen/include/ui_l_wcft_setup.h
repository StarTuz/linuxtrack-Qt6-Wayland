...
public:
    ...
    void setupUi(QWidget *WebcamFtSetupForm)
    {
        ...
        WebcamFtSetupForm->resize(483, 250);
        ...
        NeuralNetStatus = new QLabel(frame_2);
        NeuralNetStatus->setObjectName("NeuralNetStatus");

        verticalLayout_5->addWidget(NeuralNetStatus);
        ...
        ExpFilterFactor->setMinimum(1);
        ExpFilterFactor->setMaximum(100);
        ExpFilterFactor->setValue(7);
    ...
    void retranslateUi(QWidget *WebcamFtSetupForm)
    {
        ...
        label_6->setText(QCoreApplication::translate("WebcamFtSetupForm", "Neural Net Face Tracking", nullptr));
        NeuralNetStatus->setText(QCoreApplication::translate("WebcamFtSetupForm", "Status: Checking models...", nullptr));
        NeuralNetStatus->setStyleSheet(QCoreApplication::translate("WebcamFtSetupForm", "color: #888888;", nullptr));
        label_5->setText(QCoreApplication::translate("WebcamFtSetupForm", "Smoothing:", nullptr));
        label_2->setText(QCoreApplication::translate("WebcamFtSetupForm", "Smooth", nullptr));
        label->setText(QCoreApplication::translate("WebcamFtSetupForm", "Responsive", nullptr));
    } // retranslateUi
