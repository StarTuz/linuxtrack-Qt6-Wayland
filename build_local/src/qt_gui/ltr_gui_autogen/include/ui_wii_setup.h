...
public:
    ...
    void setupUi(QWidget *WiiSetupForm)
    {
        if (WiiSetupForm->objectName().isEmpty())
            WiiSetupForm->setObjectName("WiiSetupForm");
        ...
        verticalSpacer_4 = new QSpacerItem(18, 170, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
