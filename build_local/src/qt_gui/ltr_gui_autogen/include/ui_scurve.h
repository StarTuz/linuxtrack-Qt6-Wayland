...
public:
    ...
    void setupUi(QWidget *SCurveForm)
    {
        if (SCurveForm->objectName().isEmpty())
            SCurveForm->setObjectName("SCurveForm");
        ...
        SCLeftLabel->setObjectName("SCLeftLabel");
        ...
        SCLeftLimit->setObjectName("SCLeftLimit");
        ...
        SCLeftCurv->setObjectName("SCLeftCurv");
        ...
        SCRightLabel->setObjectName("SCRightLabel");
        ...
        SCSymetrical->setObjectName("SCSymetrical");
        ...
        SCRightLimit->setObjectName("SCRightLimit");
        ...
        SCRightCurv->setObjectName("SCRightCurv");
        ...
        SCFactor->setObjectName("SCFactor");
        ...
        SCDeadZone->setObjectName("SCDeadZone");
        ...
        SCFilterSlider->setObjectName("SCFilterSlider");
