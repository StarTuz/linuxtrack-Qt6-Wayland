...
public:
    ...
    void setupUi(QWidget *TirSetupForm)
    {
        if (TirSetupForm->objectName().isEmpty())
            TirSetupForm->setObjectName("TirSetupForm");
        ...
        TirStatusBright->setObjectName("TirStatusBright");
        ...
        IRBrightLabel->setObjectName("IRBrightLabel");
        ...
        IRBrightLabelLow->setObjectName("IRBrightLabelLow");
        ...
        StatusBrightLabelOff->setObjectName("StatusBrightLabelOff");
        ...
        TirFwLabel->setObjectName("TirFwLabel");

        gridLayout->addWidget(TirFwLabel, 0, 0, 1, 1);

        TirInstallFirmware = new QPushButton(frame);
        TirInstallFirmware->setObjectName("TirInstallFirmware");
        ...
        TirSignalizeStatus->setObjectName("TirSignalizeStatus");
        ...
        TirUseGrayscaleLabel->setObjectName("TirUseGrayscaleLabel");
        ...
        TirUseGrayscale->setObjectName("TirUseGrayscale");
        ...
        TirMinBlob->setObjectName("TirMinBlob");
        ...
        TirMaxBlob->setObjectName("TirMaxBlob");
        ...
        TirThresholdMin->setObjectName("TirThresholdMin");
        ...
        TirThreshold->setObjectName("TirThreshold");
        ...
        TirThresholdMax->setObjectName("TirThresholdMax");
