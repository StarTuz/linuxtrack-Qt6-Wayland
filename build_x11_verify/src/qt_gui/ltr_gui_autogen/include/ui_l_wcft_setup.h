...
public:
    ...
    QHBoxLayout *horizontalLayout_Exposure;
    ...
    void setupUi(QWidget *WebcamFtSetupForm)
    {
        ...
        horizontalLayout_Exposure = new QHBoxLayout();
        horizontalLayout_Exposure->setObjectName("horizontalLayout_Exposure");
        AutoExposure = new QCheckBox(frame);
        AutoExposure->setObjectName("AutoExposure");

        horizontalLayout_Exposure->addWidget(AutoExposure);

        label_Exposure = new QLabel(frame);
        label_Exposure->setObjectName("label_Exposure");

        horizontalLayout_Exposure->addWidget(label_Exposure);

        ExposureSlider = new QSlider(frame);
        ...
        horizontalLayout_Exposure->addWidget(ExposureSlider);


        verticalLayout_6->addLayout(horizontalLayout_Exposure);
        ...
        gridLayout->addWidget(ExpFilterFactor, 0, 2, 1, 1);
        ...
        label_thresh = new QLabel(frame_2);
        label_thresh->setObjectName("label_thresh");

        gridLayout->addWidget(label_thresh, 1, 0, 1, 1);

        label_low = new QLabel(frame_2);
        label_low->setObjectName("label_low");
        label_low->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout->addWidget(label_low, 1, 1, 1, 1);

        ConfidenceThreshold = new QSlider(frame_2);
        ConfidenceThreshold->setObjectName("ConfidenceThreshold");
        ConfidenceThreshold->setMaximum(100);
        ConfidenceThreshold->setValue(50);
        ConfidenceThreshold->setOrientation(Qt::Horizontal);
        ConfidenceThreshold->setTickPosition(QSlider::TicksBelow);
        ConfidenceThreshold->setTickInterval(10);

        gridLayout->addWidget(ConfidenceThreshold, 1, 2, 1, 1);

        label_high = new QLabel(frame_2);
        label_high->setObjectName("label_high");

        gridLayout->addWidget(label_high, 1, 3, 1, 1);
    ...
    void retranslateUi(QWidget *WebcamFtSetupForm)
    {
        ...
        AutoExposure->setText(QCoreApplication::translate("WebcamFtSetupForm", "Auto Exposure", nullptr));
        label_Exposure->setText(QCoreApplication::translate("WebcamFtSetupForm", "Exposure:", nullptr));
        label_6->setText(QCoreApplication::translate("WebcamFtSetupForm", "Facetracker Setup", nullptr));
        label_5->setText(QCoreApplication::translate("WebcamFtSetupForm", "Responsiveness (Beta):", nullptr));
        ...
        label_thresh->setText(QCoreApplication::translate("WebcamFtSetupForm", "Confidence:", nullptr));
        label_low->setText(QCoreApplication::translate("WebcamFtSetupForm", "Low", nullptr));
        label_high->setText(QCoreApplication::translate("WebcamFtSetupForm", "High", nullptr));
    } // retranslateUi
