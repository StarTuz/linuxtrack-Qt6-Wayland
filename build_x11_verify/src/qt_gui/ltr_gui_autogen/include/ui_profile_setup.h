...
public:
    ...
    void retranslateUi(QWidget *ProfileSetupForm)
    {
        ...
        oneEuroMinCutoffLow->setText(QCoreApplication::translate("ProfileSetupForm", "Smooth", nullptr));
        oneEuroMinCutoffHigh->setText(QCoreApplication::translate("ProfileSetupForm", "Jittery", nullptr));
