...
template <> constexpr inline auto WebcamFtPrefs::qt_create_metaobjectdata<qt_meta_tag_ZN13WebcamFtPrefsE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "value",
        "on_ConfidenceThreshold_valueChanged",
        "on_AutoExposure_stateChanged",
        "state",
        "on_ExposureSlider_valueChanged"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_ConfidenceThreshold_valueChanged'
        QtMocHelpers::SlotData<void(int)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 6 },
        }}),
        // Slot 'on_AutoExposure_stateChanged'
        QtMocHelpers::SlotData<void(int)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 9 },
        }}),
        // Slot 'on_ExposureSlider_valueChanged'
...
void WebcamFtPrefs::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_ExpFilterFactor_valueChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->on_ConfidenceThreshold_valueChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->on_AutoExposure_stateChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->on_ExposureSlider_valueChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
