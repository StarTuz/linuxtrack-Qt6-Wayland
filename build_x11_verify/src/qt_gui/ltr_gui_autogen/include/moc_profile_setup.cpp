...
#include "../../../../../src/qt_gui/profile_setup.h"
...
template <> constexpr inline auto ProfileSetup::qt_create_metaobjectdata<qt_meta_tag_ZN12ProfileSetupE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_OneEuroEnabled_stateChanged",
        "on_OneEuroMinCutoff_valueChanged",
        "on_OneEuroBeta_valueChanged",
        "axisChanged",
        "axis",
        "elem",
        "setCommonFF",
...
void ProfileSetup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 21: _t->on_OneEuroEnabled_stateChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 22: _t->on_OneEuroMinCutoff_valueChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 23: _t->on_OneEuroBeta_valueChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 24: _t->axisChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 25: _t->setCommonFF((*reinterpret_cast<std::add_pointer_t<float>>(_a[1]))); break;
        case 26: _t->initAxes(); break;
        default: ;
        }
    }
}
