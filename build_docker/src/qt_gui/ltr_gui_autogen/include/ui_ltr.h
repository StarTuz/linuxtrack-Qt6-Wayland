...
public:
    ...
    void setupUi(QWidget *LinuxtrackMainForm)
    {
        ...
        LALButton->setObjectName(QString::fromUtf8("LALButton"));
        ...
        UdpBridgeCheck->setObjectName(QString::fromUtf8("UdpBridgeCheck"));

        verticalLayout_23->addWidget(UdpBridgeCheck);

        UdpSettingsButton = new QPushButton(frame_7);
        UdpSettingsButton->setObjectName(QString::fromUtf8("UdpSettingsButton"));
