...
public:
    ...
    void setupUi(QWidget *TirSetupForm)
    {
        ...
        VideoOnDelayLabel->setObjectName(QString::fromUtf8("VideoOnDelayLabel"));
        ...
        TirVideoOnDelay->setObjectName(QString::fromUtf8("TirVideoOnDelay"));
        ...
        label_video_delay_unit->setObjectName(QString::fromUtf8("label_video_delay_unit"));
