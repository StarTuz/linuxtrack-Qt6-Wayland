...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Progress_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Progress_t qt_meta_stringdata_Progress = {
    {
QT_MOC_LITERAL(0, 8), // "Progress"
QT_MOC_LITERAL(9, 7), // "message"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 4), // "read"
QT_MOC_LITERAL(23, 3) // "all"

    },
    "Progress\0message\0\0read\0all"
};
...
void Progress::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->message((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qint64>>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Progress::staticMetaObject = { {
    ...
    qt_meta_stringdata_Progress.offsetsAndSize,
    qt_meta_data_Progress,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Progress_t
, QtPrivate::TypeAndForceComplete<Progress, std::true_type>
