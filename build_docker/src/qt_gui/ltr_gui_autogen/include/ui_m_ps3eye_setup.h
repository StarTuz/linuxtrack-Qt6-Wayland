...
public:
    ...
    void setupUi(QWidget *MacPS3SetupForm)
    {
        if (MacPS3SetupForm->objectName().isEmpty())
            MacPS3SetupForm->setObjectName(QString::fromUtf8("MacPS3SetupForm"));
        ...
        WebcamThresholdMac->setObjectName(QString::fromUtf8("WebcamThresholdMac"));
        ...
        WebcamMinBlobMac->setObjectName(QString::fromUtf8("WebcamMinBlobMac"));
        ...
        WebcamMaxBlobMac->setObjectName(QString::fromUtf8("WebcamMaxBlobMac"));
