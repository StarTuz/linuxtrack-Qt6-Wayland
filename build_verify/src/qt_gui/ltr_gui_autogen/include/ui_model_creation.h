...
public:
    ...
    void setupUi(QDialog *ModelCreation)
    {
        if (ModelCreation->objectName().isEmpty())
            ModelCreation->setObjectName("ModelCreation");
        ...
        MdlLayout->setObjectName("MdlLayout");
        ...
        verticalSpacer = new QSpacerItem(148, 38, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
